...
class CharNoiseAugmenter:
    ...
    def __init__(
        self,
        noise_level: float,
        actions: tuple = _AVAILABLE_ACTIONS,
        character_set: tuple = tuple(string.ascii_letters),
        seed: int = None,
    ...
    def _random_char(self, p: float, character_set: tuple) -> str:
